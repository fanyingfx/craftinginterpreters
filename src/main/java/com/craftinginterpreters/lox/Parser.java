...
//    }
    ...
    private Stmt ifStatement() {
        ...
        Expr condition = expression();
        consume(RIGHT_PAREN, "Except ')' after if condition");
...
//    }
    ...
    private Expr finishCall(Expr callee) {
        ...
        if (!check(RIGHT_PAREN)) { // Check if the arguments is null
            do {
        ...
        Token paren = consume(RIGHT_PAREN, "Except ')' after arguments.");
